        ...
        <div className="mt-12">
          <Slider {...settings}>
            {reviewers.map((reviewer, index) => (
              ...
              >
                <div
                  className="h-56 rounded-t-xl flex justify-center items-center relative overflow-hidden"
                  style={{
                ...
                >
                  <div className="absolute inset-0 bg-smoky/70 backdrop-blur-sm" />
                  <img
                    src={reviewer.photo}
                    alt={reviewer.name}
                    className="h-40 w-40 rounded-full relative z-10 object-cover border-2 border-white/20"
                  />
                </div>
                ...
                <div className="flex flex-col justify-center items-center gap-4 p-4">
                  ...
                  <button className="bg-smoky text-white text-lg py-2 px-4 rounded-xl">
                    Read More
                  </button>
                </div>
              </div>
